...
export default function EndpointGithub () {
  ...
  return (
    <div className='mt-2.5 flex items-center justify-between px-3 py-1.5 rounded-md shadow-sm dark:shadow-none bg-neutral-200/25 dark:bg-neutral-700/25'>
